...
Object Level::GetObject(std::string name)// только первый объект с заданным именем
{
...
std::vector<Object> Level::GetObjects(std::string name)// все объекты с заданным именем
{
...
void Level::Draw(sf::RenderWindow &window)// рисуем все тайлы (объекты не рисуем!)
{
